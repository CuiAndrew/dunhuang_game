...
export class Screens {
  ...
  renderMenu() {
    ...
    this.layer.querySelector('#start-button').addEventListener('click', this.onStart);
  ...
  showPause() {
    ...
    this.layer.querySelector('#resume-button').addEventListener('click', this.onResume);
    this.layer.querySelector('#restart-button').addEventListener('click', this.onRestart);
    this.layer.hidden = false;
  }
